...
|---|---|---|
| H1 | `h1-1.png` `h1-2.png` `h1-3.png` | `6874:2452` · `6874:2462` · `6874:2487` |
| H2 | `h2-1.png` `h2-2.png` `h2-3.png` | `6874:2510` · `6874:2521` · `6874:2538` |
| H3 | `h3-1.png` `h3-2.png` `h3-3.png` | `6874:2695` · `6874:2740` · `6874:2792` |

- 권장: PNG, **정사각(1:1)**, 2x. (캐러셀은 한 게시물 1:1 비율로 통일 — 세로 소재는 1:1 크롭됨)
- 슬라이드 수/매핑은 `app.js`의 `HYPO[n].figmaSlides` 에 정의 (개수 변경 시 자동 반영).
- 넣고 `git push` → 1~2분 내 라이브 반영.
